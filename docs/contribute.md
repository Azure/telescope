...
- Add the pipeline definition to [new-pipeline-test.yml](../pipelines/system/new-pipeline-test.yml) in your private branch. Make sure to re-use the existing new-pipeline-test.yml instead of a new yaml file
