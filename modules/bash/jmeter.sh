...
run_jmeter() {
  ...
  local jmeter_result_file=$5
  local jmeter_aggregate_file=$6
  local jmeter_log_file=$7
  local jmeter_properties=$8
  local result_dir=$9
  ...
  run_scp_local $privatekey_path ubuntu $egress_ip_address "${jmeter_file_dest}/${jmeter_aggregate_file}.csv" "${result_dir}/${jmeter_aggregate_file}.csv"
  run_scp_local $privatekey_path ubuntu $egress_ip_address "${jmeter_file_dest}/${jmeter_result_file}.csv" "${result_dir}/${jmeter_result_file}.csv"
}
