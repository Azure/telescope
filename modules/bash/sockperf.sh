...
collect_result_sockperf() {
  ...
  data=$(jq --null-input \
    ...
    '{timestamp: $timestamp, metric: $metric, unit: $unit, result_info: $result_info, cloud_info: $cloud_info, egress_ip: $egress_ip, ingress_ip: $ingress_ip, run_id: $run_id, run_url: $run_url, datapath: $datapath, test_engine: "sockperf"}')
