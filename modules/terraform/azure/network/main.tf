...
resource "azurerm_subnet" "subnet" {
  ...
  private_endpoint_network_policies             = each.value.private_endpoint_network_policies_enabled != null && each.value.private_endpoint_network_policies_enabled == false ? "Disabled" : "Enabled"
