locals {
  ...
  aks_custom_headers       = lookup(var.json_input, "aks_custom_headers", null)
    ...
    for aks in var.aks_cli_config_list : [
      {
        ...
        aks_custom_headers            = local.aks_custom_headers != null ? local.aks_custom_headers : aks.aks_custom_headers
