locals {
  ...
  aks_cli_default_node_pool        = lookup(var.json_input, "aks_cli_default_node_pool", null)
  aks_cli_extra_node_pool          = lookup(var.json_input, "aks_cli_extra_node_pool", null)
    ...
    for aks in var.aks_cli_config_list : [
      {
        ...
        default_node_pool             = local.aks_cli_default_node_pool != null ? local.aks_cli_default_node_pool : aks.default_node_pool
        extra_node_pool               = local.aks_cli_extra_node_pool != null ? local.aks_cli_extra_node_pool : aks.extra_node_pool
      }
    ]
  ]) : []
