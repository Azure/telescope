...
class TestKubernetesClient(unittest.TestCase):
    ...
    @patch('clients.kubernetes.KubernetesClient.get_nodes')
    ...
    @patch('clients.kubernetes.KubernetesClient.create_namespace')
    @patch('clients.kubernetes.KubernetesClient.delete_namespace')
    ...
    @patch('clients.kubernetes.KubernetesClient.get_pods_by_namespace')
    ...
    @patch('clients.kubernetes.KubernetesClient.get_persistent_volume_claims_by_namespace')
    ...
    @patch('clients.kubernetes.KubernetesClient.get_volume_attachments')
