...
class TestNodePoolCRUDFunctions(unittest.TestCase):
    ...
    def test_handle_node_pool_operation_scale(self, mock_azure_crud):
        ...
        mock_args.scale_step_size = 1  # scale_step_size != target_count, so progressive=True
        mock_args.gpu_node_pool = False
    ...
    def test_handle_node_pool_operation_scale_non_progressive(self, mock_azure_crud):
        ...
        mock_args.scale_step_size = 3  # scale_step_size == target_count, so progressive=False
        mock_args.gpu_node_pool = False
    ...
    def test_check_for_progressive_scaling_true(self):
        ...
        # Execute
        from crud.main import check_for_progressive_scaling
    ...
    def test_handle_node_pool_operation_exception(self, mock_azure_crud, mock_logger):
        ...
        # Verify
        self.assertEqual(result, 1)  # 1 means error
        mock_logger.error.assert_called_with("Error during 'create' operation: Test error")
    ...
    def test_main_gpu_node_pool_logic(self):
        ...
        from crud.main import handle_node_pool_operation, check_for_progressive_scaling
...
class TestCollectBenchmarkResults(unittest.TestCase):
    ...
    def test_collect_benchmark_results_success(self, mock_datetime, mock_glob, mock_get_env_vars):
    ...
    @mock.patch("crud.main.get_env_vars")
    @mock.patch("crud.main.glob.glob")
    def test_collect_benchmark_results_skip_results_json(self, mock_glob, mock_get_env_vars):
...
class TestHandleNodePoolAll(unittest.TestCase):
    ...
    def test_handle_node_pool_all_success(self, mock_logger):
        ...
        # Execute
        from crud.main import handle_node_pool_all
        result = handle_node_pool_all(mock_node_pool_crud, mock_args)

        # Verify
        self.assertEqual(result, 0)
        mock_node_pool_crud.all.assert_called_once()
        mock_logger.info.assert_called_with("All node pool operations completed successfully")
    ...
    def test_handle_node_pool_all_exception(self, mock_logger):
        ...
        # Verify
        self.assertEqual(result, 1)
        mock_logger.error.assert_called_with("Error during all operations sequence: Test error")
...
class TestMainFunctionIntegration(unittest.TestCase):
    ...
    @mock.patch("crud.main.AzureNodePoolCRUD")
    def test_main_complete_create_operation(self, mock_azure_crud_class, mock_operation_context, mock_exit):
    ...
    @mock.patch("crud.main.OperationContext")
    @mock.patch("crud.main.AzureNodePoolCRUD")
    def test_main_operation_returns_none(self, mock_azure_crud_class, mock_operation_context, mock_exit):
    ...
    @mock.patch("crud.main.OperationContext")
    @mock.patch("crud.main.AzureNodePoolCRUD")
    def test_main_operation_returns_boolean_false(self, mock_azure_crud_class, mock_operation_context, mock_exit):
    ...
    def test_main_import_error_handling(self, mock_logger, mock_exit):
        ...
        test_args = ["crud.py", "create", "--cloud", "unsupported", "--run-id", "test", "--node-pool-name", "test"]
    ...
    def test_main_general_exception_handling(self, mock_parse_args, mock_logger, mock_exit):
    ...
    @mock.patch("crud.main.OperationContext")
    @mock.patch("crud.main.AzureNodePoolCRUD")
    def test_main_gpu_node_pool_enabled(self, mock_azure_crud_class, mock_operation_context, mock_exit):
    ...
    @mock.patch("crud.main.OperationContext")
    @mock.patch("crud.main.AzureNodePoolCRUD")
    def test_main_gpu_verification_fails(self, mock_azure_crud_class, mock_operation_context, mock_exit):
...
class TestGetNodePoolCRUDClassErrorHandling(unittest.TestCase):
    ...
    def test_get_node_pool_crud_class_aws_not_implemented(self):
        ...
        from crud.main import get_node_pool_crud_class
    ...
    def test_get_node_pool_crud_class_random_provider(self):
        ...
        self.assertIn("Unsupported cloud provider: random_provider", str(context.exception))
