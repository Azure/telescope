...
class TestAKSClient(unittest.TestCase):
    ...
    def setUp(self, mock_k8s_client, mock_mi_cred, mock_cs_client):
    ...
    def test_get_cluster_name_from_api(self):
        ...
        self.mock_managed_clusters.list_by_resource_group.assert_called_once_with("fake-resource-group")
    ...
    def test_get_cluster_data(self):
        ...
        # Setup
        mock_cluster = mock.MagicMock()
        mock_cluster.as_dict.return_value = {"name": "fake-cluster", "location": "eastus"}
    ...
    def test_create_node_pool_gpu(self, mock_time):
        ...
        self.mock_k8s.verify_nvidia_smi_on_node = mock.MagicMock(return_value="GPU 0: Tesla V100")
    ...
    def test_record_metrics(self):
        ...
        self.mock_managed_clusters.get.side_effect = HttpResponseError(message="Not found")
        ...
        files = [f for f in os.listdir(self.test_result_dir) if f.startswith('azure_create_node_pool_')]
        self.assertEqual(len(files), 1)
        
        # Verify the content of the file
        with open(os.path.join(self.test_result_dir, files[0]), 'r') as f:
            data = json.load(f)
