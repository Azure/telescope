...
def calculate_cpu_request_for_clusterloader2(
    ...
    # Consider 15% less CPU request for deployment pods to account for
    # non-kube-system DaemonSet overhead that Karpenter includes in bin-packing
