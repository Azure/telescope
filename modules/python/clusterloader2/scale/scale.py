...
def configure_clusterloader2(
    ...
    generate_container_network_metrics_filtering,
    label_traffic_pods,
    override_file):
    ...
    with open(override_file, 'w', encoding='utf-8') as file:
        ...
        file.write(f"CL2_GENERATE_CONTAINER_NETWORK_METRICS_FILTERING: {generate_container_network_metrics_filtering}\n")
...
def collect_clusterloader2(
    ...
    template = {
        ...
        "test_details": {
            ...
            "generate_container_network_metrics_filtering": generate_container_network_metrics_filtering,
...
def main():
    ...
    parser_configure.add_argument("--generate-container-network-metrics-filtering", type=str2bool, choices=[True, False], nargs='?', default=False, help="Generate Container Network Metrics Filtering (default=False)")
    ...
    parser_collect.add_argument("--generate-container-network-metrics-filtering", type=str2bool, choices=[True, False], nargs='?', default=False, help="Generate Container Network Metrics Filtering (default=False)")
    ...
    if args.command == "configure":
        configure_clusterloader2(args.fortio_servers_per_deployment,
                                 ...
                                 args.generate_container_network_metrics_filtering,
