...
def collect_clusterloader2(
    ...
    template = {
        ...
        "fortio_server_deployments": fortio_server_deployments,
        "fortio_client_deployments": fortio_client_deployments,
        "fortio_client_replicas_per_deployment": fortio_client_replicas_per_deployment,
        "fortio_server_replicas_per_deployment": fortio_server_replicas_per_deployment,
