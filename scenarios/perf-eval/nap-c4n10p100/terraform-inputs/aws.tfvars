...
eks_config_list = [{
  ...
  vpc_name         = "nap-vpc"
  policy_arns      = ["AmazonEKSServicePolicy", "AmazonEKSClusterPolicy", "AmazonEKSVPCResourceController", "AmazonEKSWorkerNodePolicy", "AmazonEKS_CNI_Policy", "AmazonEC2ContainerRegistryReadOnly", "AmazonSSMManagedInstanceCore"]
