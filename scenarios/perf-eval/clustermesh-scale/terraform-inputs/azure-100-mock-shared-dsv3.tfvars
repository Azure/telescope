...
# (SHARED-VNET / DSv3)
#
# DSv3 port of azure-100-mock-shared.tfvars: identical network, Fleet,
# service-CIDR, mock, churnpool, and scenario shape. Use only in a region where
# the live ManagedClusters, DSv3, regional-core, network, telemetry, and
# ClusterMesh gates pass.
#
# Each default pool remains a THIN 2 × Standard_D8s_v3 worker pool hosting only
...
#
# Per-cluster sizing:
#   - default pool: 2 × Standard_D8s_v3 = 16 vCPU (DSv3) — hosts 100 mock-agents
#     (~9m CPU/56Mi each, measured) + the CL2 measurement client. max-pods 110.
#   - prompool:     1 × Standard_D8s_v3 = 8  vCPU (DSv3) — labeled prometheus=true.
