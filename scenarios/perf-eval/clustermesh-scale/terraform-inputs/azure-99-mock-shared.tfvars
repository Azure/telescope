...
# =============================================================================
# ClusterMesh Scale Test — 99 cluster pagination-boundary tier — MOCK
# (SHARED-VNET)
#
...
# 19/20 clusters PASS, Fleet meshed all 20). This file is the n=99 shared-VNet
...
#   Total per cluster: 24 vCPU. N=99 base total: 2376 vCPU, plus the
#   3-node churn pool on mesh-1. This fits Dv3 quota in 37deca/eastus2euap.
#
# Topology:
...
#
# The unused mesh-100 subnet pair is retained to keep the network plan
# identical while AKS and Fleet contain exactly 99 clusters/members.
#
# Fleet:
#   - 99 fleet members (mesh-1..mesh-99), initially labeled mesh=staged
