...
# =============================================================================
# ClusterMesh Scale Test - 90 cluster Fleet threshold probe (SHARED-VNET)
#
# Derived from the successful N=75 validation without changing per-cluster shape.
# This is the next probe below the prior N=99 stall.
#
# Per-cluster sizing:
#   - default pool: 10 x Standard_D4_v3 = 40 vCPU (Dv3)
#   - prompool:     1  x Standard_D8_v3 = 8 vCPU (Dv3)
#   Total per cluster: 48 vCPU. N=90 total: 4320 vCPU.
#
# Topology:
#   - 1 shared VNet 10.0.0.0/8
#   - 180 subnets: node 10.X.0.0/24 + pod 10.X.4.0/22 for X in [1..90]
#   - 0 VNet peerings; pod-to-pod routing is native within the shared VNet
#   - AKS service CIDR 192.168.0.0/24 on every cluster
#
# Fleet:
#   - 90 members (mesh-1..mesh-90), labeled mesh=true
