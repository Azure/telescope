...
# (SHARED-VNET / DSv3)
#
# Region-neutral DSv3 topology used only where the pipeline's live quota,
...
# worker pool (2 x Standard_D8s_v3) instead of real workload nodes.
...
# them pack onto 2 x D8s_v3 at 5-8% CPU. This is the ~10x vCPU reduction: a real
...
aks_cli_config_list = [
  {
    ...
    # At 100 mock agents/cluster x ~9m CPU / ~56Mi, 100 Pods pack onto two
    # D8s_v3 nodes (16 vCPU / 64Gi). The n=2 steady state needs 72 vCPU; the
    # mesh-1 churnpool 3→8 stimulus peaks at 112 vCPU total.
    default_node_pool = {
      name                 = "default"
      node_count           = 2
