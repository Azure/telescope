...
# =============================================================================
# ClusterMesh Scale Test - 99 cluster comparable threshold probe (SHARED-VNET)
#
# Derived from the successful N=90 validation without changing per-cluster shape.
# This isolates member count from the older staged/mock N=99 experiment.
#
# Per-cluster sizing:
#   - default pool: 10 x Standard_D4_v3 = 40 vCPU (Dv3)
#   - prompool:     1  x Standard_D8_v3 = 8 vCPU (Dv3)
#   Total per cluster: 48 vCPU. N=99 total: 4752 vCPU.
#
# Topology:
#   - 1 shared VNet 10.0.0.0/8
#   - 198 subnets: node 10.X.0.0/24 + pod 10.X.4.0/22 for X in [1..99]
#   - 0 VNet peerings; pod-to-pod routing is native within the shared VNet
#   - AKS service CIDR 192.168.0.0/24 on every cluster
#
# Fleet:
#   - 99 members (mesh-1..mesh-99), labeled mesh=true
