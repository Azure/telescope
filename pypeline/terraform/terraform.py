...
def set_input_file(cloud: str, regions: str, input_file_mapping: dict, scenario_name:str, scenario_type:str) -> Script:
...
def set_user_data_path(user_data_path: str, scenario_type:str, scenario_name:str) -> Script:
    if user_data_path:
    ...
    def setup(self) -> list[Step]:
        return [
            ...
            set_input_file(
                ...
                self.scenario_name, self.scenario_type
            ),
